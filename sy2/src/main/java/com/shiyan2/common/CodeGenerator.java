...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        String projectPath = "E:/HMSpringBoot/sy2";
        ...
        // ⼀、修改数据源
        dsc.setUrl("jdbc:mysql://localhost:3306/test2?useUnicode=true&characterEncoding=UTF8&useSSL=false");
                // dsc.setSchemaName("public");
                dsc.setDriverName("com.mysql.cj.jdbc.Driver");
        dsc.setUsername("root");
        dsc.setPassword("ls885331");
        mpg.setDataSource(dsc);
        // 包配置
        PackageConfig pc = new PackageConfig();
        //pc.setModuleName(scanner("模块名"));
        // ⼆、模块配置
        pc.setParent("com.shiyan2")
                .setEntity("entity")
                .setMapper("mapper")
                .setService("service")
